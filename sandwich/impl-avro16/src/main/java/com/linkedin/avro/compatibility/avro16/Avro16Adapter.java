...
public class Avro16Adapter implements AvroAdapter {
    private static final Logger LOG = LogManager.getLogger(Avro16Adapter.class);

    private Avro16CompilerOperations compilerOperations = null;

    public Avro16Adapter() {
        try {
            compilerOperations = new Avro16CompilerOperations();
