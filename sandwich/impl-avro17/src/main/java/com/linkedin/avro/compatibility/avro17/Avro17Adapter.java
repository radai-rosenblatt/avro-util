...
public class Avro17Adapter implements AvroAdapter {
    private static final Logger LOG = LogManager.getLogger(Avro17Adapter.class);

    private Avro17CompilerOperations compilerOperations = null;

    public Avro17Adapter() {
        try {
            compilerOperations = new Avro17CompilerOperations();
